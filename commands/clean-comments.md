...
Goal: high-signal, minimal comments. Every remaining comment must tell a competent engineer something they could not infer from the surrounding code. Prefer *why* over *what*.
...
files reviewed, kinds of comments removed, meaningful docs preserved, useful comments added, and confirmation that behavior was unchanged.
